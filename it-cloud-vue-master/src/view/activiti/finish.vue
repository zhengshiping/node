...
import { getFinishTaskTableData } from '@/api/activiti'
...
export default {
  ...
  data () {
    ...
    return {
      ...
      columns: [
        ...
        {
          title: '流程实例ID',
          key: 'actHiProcinst.id',
          width: 100,
          render: (h, params) => {
            return h('span', params.row.actHiProcinst.id)
          }
        },
        {
          title: '流程名称',
          key: 'actHiProcinst.name',
          width: 150,
          render: (h, params) => {
            return h(
              'Tooltip',
              ...
              [
                this.maxSlice(params.row.actHiProcinst.name),
                h(
                  'span',
                  {
                    slot: 'content',
        ...
        },
        {
          ...
          render: (h, params) => {
            return h(
              ...
              [
                this.maxSlice(params.row.actHiProcinst.businessKey),
                h(
                  'span',
                  {
                    slot: 'content',
                  ...
                  params.row.actHiProcinst.businessKey
                )
              ]
            )
          }
        ...
        { title: '申请人', key: 'userName', width: 100 },
        {
          ...
          width: 100,
          render: (h, params) => {
            const duration = params.row.actHiProcinst.duration
            var text = ''
            if (duration != null) {
        ...
        {
          title: '开始时间',
          key: 'actHiProcinst.startTime',
          width: 200,
          render: (h, params) => {
            return h('span', params.row.actHiProcinst.startTime)
          }
        },
        {
          title: '结束时间',
          key: 'actHiProcinst.endTime',
          width: 200,
          render: (h, params) => {
            return h('span', params.row.actHiProcinst.endTime)
          }
        },
        {
          title: '操作',
  ...
  methods: {
    ...
    handleSearch () {
      ...
      getFinishTaskTableData(params).then(res => {
        if (res.data.success) {
